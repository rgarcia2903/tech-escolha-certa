...
const recommendedPicks = [
  {
    ...
    description:
      "A melhor opção Samsung para quem quer equilíbrio entre preço, tela, bateria e experiência segura.",
  ...
  },
  {
    ...
    description:
      "O modelo mais equilibrado para quem quer experiência acima da média sem pagar preço de topo de linha.",
  ...
  },
  {
    ...
    description:
      "Excelente opção para quem busca ficha técnica forte, tela bonita e carregamento rápido.",
