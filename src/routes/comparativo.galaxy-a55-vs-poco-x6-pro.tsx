  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "Galaxy A55 vs Poco X6 Pro, Galaxy A55 ou Poco X6 Pro, melhor celular até 2000, comparativo Samsung Xiaomi",
      },
      {
        property: "og:title",
...
const Poco = {
  ...
  strengths: [
    "Processador Dimensity 8300-Ultra muito superior",
    "Excelente para jogos e multitarefa",
    "Tela AMOLED 120 Hz com ótima qualidade",
    "Carregamento rápido de 67 W",
    "Ótimo custo-benefício para quem busca desempenho",
  ],
  weaknesses: [
    "Construção inferior ao Galaxy A55",
    "Proteção IP54 contra IP67 do Galaxy",
    "Câmeras ficam atrás do Galaxy A55",
    "HyperOS divide opiniões",
...
const QUICK_SCORE = [
  ...
  { category: "Custo-benefício", winner: "Poco X6 Pro", reason: "geralmente custa menos" },
];
...
const FAQS = [
  {
    q: "Galaxy A55 ou Poco X6 Pro: qual é melhor?",
    a: "O Galaxy A55 é melhor para quem quer construção premium, câmeras mais consistentes e software mais confiável. O Poco X6 Pro é melhor para quem quer mais ficha técnica, carregamento rápido e preço agressivo.",
  },
  {
  ...
  },
  {
    ...
    a: "Para jogos e uso mais pesado, o Poco X6 Pro tende a ser mais interessante pelo conjunto de desempenho e carregamento rápido. Para estabilidade geral, o A55 segue mais equilibrado.",
  },
  {
      ...
      <header className="relative overflow-hidden border-b border-border bg-surface">
        ...
        <div className="container-tec relative py-14 md:py-20">
          <nav className="mb-5 flex items-center gap-2 text-xs text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground">Galaxy A55 vs Poco X6 Pro</span>
          </nav>
          ...
          <PurchaseActions
            ...
            options={[
              ...
              { productName: "Poco X6 Pro", href: POCO_X6_PRO_AFFILIATE_URL },
            ]}
          ...
          <div className="mt-8 grid gap-5 lg:grid-cols-2">
            ...
            <ProductHero product={Poco} accent="cta" />
          </div>
        </div>
      </header>
      ...
      <div className="container-tec grid gap-10 py-14 lg:grid-cols-12 lg:gap-12">
        ...
        <main className="lg:col-span-9 space-y-14">
          <section id="veredito" className="scroll-mt-24">
            ...
            <div className="mt-5 rounded-2xl border border-border bg-card p-6 md:p-8 shadow-soft">
              <p className="text-lg leading-relaxed text-foreground">
                ...
                previsíveis. O <strong>Poco X6 Pro</strong> é mais interessante para quem busca
          ...
          <ComparisonBlock
            ...
            title="Galaxy A55 parece mais premium; Poco foca em praticidade"
            winner="Galaxy A55"
            paragraphs={[
              ...
              "O Poco X6 Pro também é bonito e confortável, mas tem proposta mais funcional. Ele entrega boa pegada, corpo fino e design moderno, porém a proteção IP54 e a construção menos refinada deixam claro que o foco está no custo-benefício, não na sensação premium.",
            ]}
            bullets={[
              "Galaxy A55: vidro, alumínio e IP67",
              "Poco: mais leve na proposta, porém menos protegido",
          ...
          <ComparisonBlock
            ...
            paragraphs={[
              "Os dois entregam telas AMOLED de 120 Hz com ótima nitidez, cores fortes e excelente experiência para YouTube, Instagram, TikTok e streaming. O Poco costuma impressionar pela resolução e brilho, enquanto o Galaxy A55 traz calibração mais natural e consistência melhor em diferentes ambientes.",
              "Na prática, qualquer um dos dois vai agradar quem está saindo de celulares básicos. O Poco pode parecer mais chamativo no primeiro contato; o Galaxy é mais equilibrado para uso longo, com menos saturação exagerada.",
            ]}
            bullets={[
              "Ambos têm AMOLED 120 Hz",
              "Poco chama mais atenção em brilho e ficha técnica",
          ...
          <ComparisonBlock
            ...
            bullets={[
              "Poco leva vantagem em ficha técnica e carga de trabalho",
          ...
          <ComparisonBlock
            ...
            title="Autonomia parecida, mas Poco ganha no carregamento"
            winner="Poco X6 Pro"
            paragraphs={[
              "Na autonomia, os dois passam o dia com folga em uso misto: redes sociais, streaming, câmera, navegação e mensagens. O Galaxy A55 é eficiente e previsível, enquanto o Poco X6 Pro se destaca por recarregar muito mais rápido.",
              "A diferença prática está na tomada. O carregamento de 67 W do Poco muda o uso diário: poucos minutos já recuperam bateria suficiente para várias horas. O Galaxy A55, com 25 W, parece lento nesse ponto — especialmente para quem já usou Xiaomi, Realme ou Motorola com carga rápida.",
            ]}
            bullets={[
              "Ambos aguentam um dia de uso",
              "Poco carrega muito mais rápido",
          ...
          <ComparisonBlock
            ...
            icon={Gamepad2}
            eyebrow="Jogos"
            title="Para gaming casual, ambos servem; para desempenho, Poco é melhor"
            winner="Poco X6 Pro"
            paragraphs={[
          ...
          <section id="tabela" className="scroll-mt-24">
            ...
            <div className="mt-6 overflow-hidden rounded-2xl border border-border bg-card shadow-soft">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {SPECS.map(([label, a55, Poco], index) => (
                    <tr key={label} className={index % 2 === 0 ? "bg-card" : "bg-surface"}>
                      ...
                      <td className="px-5 py-3 text-muted-foreground">{Poco}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <h2 className="mt-2 font-heading text-2xl font-bold text-foreground">
                  Galaxy A55 é mais seguro; Poco é mais agressivo no preço.
                </h2>
                <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground">
                  Para a maioria, o Galaxy A55 é a recomendação mais equilibrada. Para quem quer
                  economizar e valoriza carregamento rápido, o Poco X6 Pro pode ser a melhor compra.
                </p>
              </div>
