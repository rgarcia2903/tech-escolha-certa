...
export const Route = createFileRoute("/comparativo/poco-x6-pro-vs-poco-x7-pro")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:image",
        content: "https://techescolhacerta.com.br/images/products/poco-x7-pro-optimized.webp",
      },
      {
        ...
        <div className="container-tec relative py-14 md:py-20">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-5 max-w-3xl text-base md:text-lg text-muted-foreground leading-relaxed text-pretty">
              O Poco X6 Pro ainda é um intermediário muito forte, mas o Poco X7 Pro chegou com
              bateria maior, chip mais novo, carregamento mais rápido e proteção superior.
          ...
          <div className="sticky top-24 space-y-6">
            ...
            <div className="rounded-2xl border border-cta/30 bg-card p-5 shadow-soft ring-1 ring-cta/10">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                O Poco X7 Pro é a escolha mais completa. O Poco X6 Pro só leva vantagem se estiver
                com preço bem menor.
              </p>
              <div className="mt-4 space-y-2">
                <AffiliateButton
                  product={POCO_X7}
                  label="Ver Poco X7 Pro no Mercado Livre"
                  variant="primary"
                />
                <AffiliateButton
                  product={POCO_X6}
        ...
        <main className="lg:col-span-9 space-y-14">
          <section id="veredito" className="scroll-mt-24">
            <SectionTitle
              ...
              title="Qual é melhor: Poco X6 Pro ou Poco X7 Pro?"
            />
            <div className="mt-5 rounded-2xl border border-border bg-card p-6 md:p-8 shadow-soft">
              <p className="text-lg leading-relaxed text-foreground">
                O <strong>Poco X7 Pro</strong> é a melhor escolha para quem quer o conjunto mais
                atual: mais desempenho, bateria maior, carregamento de 90 W e proteção IP68. O{" "}
                <strong>Poco X6 Pro</strong> ainda vale a pena se aparecer com preço bem mais baixo,
          ...
          <section id="tabela" className="scroll-mt-24">
            <SectionTitle
              ...
              title="Poco X6 Pro vs Poco X7 Pro em detalhes"
            />
            <div className="mt-6 overflow-hidden rounded-2xl border border-border bg-card shadow-soft">
            ...
            <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground">
                  Para comprar hoje e ficar mais tempo, o Poco X7 Pro é a escolha mais completa. Se
                  o Poco X6 Pro aparecer muito mais barato, ele ainda pode ser uma compra
                  inteligente.
                </p>
              </div>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/95 p-3 backdrop-blur lg:hidden">
        <div className="container-tec flex items-center gap-3">
          <div className="min-w-0 flex-1">
            ...
            <span className="font-heading text-sm font-bold text-foreground">X6 Pro vs X7 Pro</span>
          </div>
          <a
